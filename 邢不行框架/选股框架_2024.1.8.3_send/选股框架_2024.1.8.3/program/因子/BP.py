...
ipt_fin_cols = ['B_total_equity_atoopc@xbx']  # 输入的财务字段，财务数据上原始的

opt_fin_cols = ['B_total_equity_atoopc@xbx']  # 输出的财务字段，需要保留的
...
def cal_factors(data, fin_data, fin_raw_data, exg_dict):
    ...
    # BP（市净率倒数） = (总资产 - 总负债) / 市值 = 每股净资产 / 每股市值
    # B_total_equity_atoopc@xbx：资产负债表_所有者权益的归属于母公司所有者权益合计（等价于 总资产 - 总负债）
    data['BP'] = data['B_total_equity_atoopc@xbx'] / data['总市值']
    exg_dict['BP'] = 'last'
